...
const PrivacyPolicyPage = () => {
            ...
            content: [
                {
                    ...
                    details: 'We collect information you provide directly, including your name, email address, phone number, medical history related to bariatric surgery, dietary preferences, and health goals.'
                },
                {
                    subtitle: 'Health Data',
                    details: 'With your consent, we may collect health-related information including surgery type, recovery phase, weight measurements, and nutritional tracking data to personalize your meal plans.'
                },
                {
                    subtitle: 'Usage Information',
                    details: 'We automatically collect information about how you interact with our platform, including pages visited, features used, and time spent on our services.'
                }
            ]
        },
        {
            ...
            content: [
                {
                    ...
                    details: 'We use your information to create customized meal plans, provide nutritional recommendations, and deliver content tailored to your specific bariatric surgery needs.'
                },
                {
                    subtitle: 'Communication',
                    details: 'We may contact you with important updates about your meal plans, nutritional guidance, appointment reminders, and educational content related to post-surgery nutrition.'
                },
                {
                    subtitle: 'Service Improvement',
                    details: 'We analyze usage patterns and feedback to continuously improve our meal planning algorithms, user experience, and educational resources.'
                }
            ]
        },
        {
            ...
            content: [
                {
                    ...
                    details: 'With your explicit consent, we may share relevant nutritional data with your bariatric surgeon, registered dietitian, or other healthcare providers involved in your care.'
                },
                {
                    subtitle: 'Service Providers',
                    details: 'We work with trusted third-party service providers who assist with payment processing, email delivery, and customer support. These providers are bound by strict confidentiality agreements.'
                },
                {
                    subtitle: 'Legal Requirements',
                    details: 'We may disclose information when required by law, to protect our rights, or in response to valid legal requests from authorities.'
                }
            ]
        },
        {
            ...
            content: [
                {
                    subtitle: 'Encryption',
                    details: 'All sensitive data is encrypted both in transit and at rest using industry-standard encryption protocols. Your health information receives the highest level of protection.'
                },
                {
                    subtitle: 'Access Controls',
                    details: 'We implement strict access controls ensuring only authorized personnel can access your information, and all access is logged and monitored.'
                },
                {
                    subtitle: 'Regular Audits',
                    details: 'Our security measures undergo regular audits and assessments to ensure compliance with healthcare privacy standards and best practices.'
                }
            ]
        },
        {
            ...
            content: [
                {
                    ...
                    details: 'You have the right to access, download, and transfer your personal data. You can request a copy of all information we have about you at any time.'
                },
                {
                    subtitle: 'Correction & Update',
                    details: 'You can update your personal information, health data, and preferences through your account settings or by contacting our support team.'
                },
                {
                    subtitle: 'Deletion',
                    details: 'You may request deletion of your account and associated data. Some information may be retained for legal or safety reasons as permitted by law.'
                }
            ]
        },
        {
            ...
            content: [
                {
                    ...
                    details: 'We use necessary cookies to ensure our platform functions properly, maintain your session, and remember your preferences and settings.'
                },
                {
                    subtitle: 'Analytics',
                    details: 'We use analytics tools to understand how our services are used and to improve user experience. You can opt out of analytics tracking in your account settings.'
                },
                {
                    subtitle: 'Marketing',
                    details: 'With your consent, we may use cookies for personalized marketing and to show you relevant content. You can manage these preferences at any time.'
                }
            ]
        }
    ];
    ...
    const quickLinks = [
        { name: 'Information Collection', id: 'information-collection' },
        { name: 'Information Use', id: 'information-use' },
        { name: 'Information Sharing', id: 'information-sharing' },
        { name: 'Data Security', id: 'data-security' },
        { name: 'Your Rights', id: 'your-rights' },
        { name: 'Cookies & Tracking', id: 'cookies-tracking' }
    ];
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-blue-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-xl font-semibold text-gray-600">Loading Privacy Policy...</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="flex items-center space-x-4 group cursor-pointer relative">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-xs text-gray-500 group-hover:text-emerald-500 transition-colors duration-300 -mt-1">Privacy Policy</p>
                            </div>
                        </div>

                        {/* Desktop Navigation */}
                        <div className="hidden lg:flex items-center space-x-6">
                            <a onClick={() => router.push("/home")} className="cursor-pointer text-gray-700 hover:text-emerald-600 transition-colors duration-300 font-medium">
                                Back to Home
                            </a>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12" data-animate id="hero-content">
                        ...
                        <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                            Your privacy and data security are fundamental to our mission. Learn how we protect your personal health information
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-700 leading-relaxed mb-4">
                                            BariatricPlan provides nutritional guidance and meal planning services. We are not a substitute for professional medical advice,
                                            diagnosis, or treatment. Always consult with your bariatric surgeon, registered dietitian, or healthcare provider before making
                                            changes to your post-surgery nutrition plan.
                                        </p>
                                        <p className="text-gray-700 leading-relaxed">
                                            Your health information is protected under applicable privacy laws including HIPAA where applicable. We maintain the highest
                                            standards of data security and will never sell your personal health information to third parties.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl p-8 text-white shadow-2xl">
                                <div className="text-center">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                        <a
                                            href="mailto:privacy@bariatricplan.com"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                <a onClick={() => router.push("/termsofservice")} className="cursor-pointer text-gray-400 hover:text-emerald-400 transition-colors duration-300 block">
                                    Terms of Service
                                </a>
                    ...
                    <div className="border-t border-gray-800 mt-12 pt-8 text-center">
                        <p className="text-gray-400 text-sm">
                            © 2024 BariatricPlan. All rights reserved. This privacy policy is effective as of August 28, 2025.
                        </p>
                    </div>
                </div>
            </footer>
